...
async function restore() {
  const backup = JSON.parse(fs.readFileSync('/Volumes/SSD/Development/Customers/PaleHall/pale-art-websites/pale-art-may25/backups/full-backup-2025-06-16T16-16-37.json', 'utf-8'))
