...
async function restore() {
  const backup = JSON.parse(fs.readFileSync('/Volumes/SSD/Development/Customers/PaleHall/pale-art-websites/pale-art-may25/backups/full-backup-2025-06-15T20-38-28.json', 'utf-8'))
